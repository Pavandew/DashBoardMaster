...
object AppConstants {
    ...
    const val FIELD_SERVICE_CHARGE = "serviceChargeAmount"
    ...
    const val KEY_UPI_ID = "key_upi_id"
    const val KEY_UPI_QR_URL = "key_upi_qr_url"
    const val KEY_SERVICE_CHARGE_ENABLED = "key_service_charge_enabled"
    const val KEY_SERVICE_CHARGE_PERCENT = "key_service_charge_percent"
    const val KEY_SERVICE_CHARGE_LABEL = "key_service_charge_label"
    const val KEY_SERVICE_CHARGE_DINE_IN_ONLY = "key_service_charge_dine_in_only"
    const val KEY_SERVICE_CHARGE_APPLY_TAX = "key_service_charge_apply_tax"
    const val KEY_GST_RATE = "key_gst_rate"
    const val KEY_TAX_ENABLED = "key_tax_enabled"
    const val KEY_TAX_LABEL = "key_tax_label"
    const val KEY_TAX_PRICE_INCLUSIVE = "key_tax_price_inclusive"
